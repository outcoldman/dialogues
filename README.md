...
~~~sh
# getting the code
git clone git@github.com:nko4/outcold.git && cd ./outcold/

# developing
npm install
npm start

# deploying (to http://outcold.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@outcold.2013.nodeknockout.com
ssh root@outcold.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@outcold.2013.nodeknockout.com
ssh -i ./id_deploy root@outcold.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/outcold" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
