...
var CommentView = function(options, $parent, comment) {
  var that = this;

  var _render = options.render;
  var _selectors = _render.selectors;
  var _dateFormatter = options.dateFormatter;
  var _bodyFormatter = options.bodyFormatter;
  ...
  that.render = function() {
    ...
    var name = comment.name || options.resources.anonymous;
