...
MiddlewareProcessor.prototype.in = function(req, res, comments, cb) {
  this._process(this.middleware.in, req, res, comments, cb);
};

MiddlewareProcessor.prototype.out = function(req, res, comments, cb) {
  this._process(this.middleware.out, req, res, comments, cb);
};

MiddlewareProcessor.prototype._process = function(middleware, req, res, comments, cb) {
